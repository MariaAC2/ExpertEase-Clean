...
namespace ExpertEase.Infrastructure.Migrations
{
    ...
    [Migration("20250616015528_ModifiedOrderServiceTaskPayment")]
    partial class ModifiedOrderServiceTaskPayment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpertEase.Domain.Entities.Payment", b =>
                {
                    b.HasOne("ExpertEase.Domain.Entities.Reply", "Reply")
                        .WithOne("Payment")
                        .HasForeignKey("ExpertEase.Domain.Entities.Payment", "ReplyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
