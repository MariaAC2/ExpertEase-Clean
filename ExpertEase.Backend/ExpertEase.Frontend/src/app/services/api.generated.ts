...
export class Client extends BaseClient {
     ...
     * @return OK
     */
    account(): Observable<AccountDTORequestResponse> {
     ...
     * @return OK
     */
    update(body: AccountUpdateDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    accountsGET(id: string): Observable<AccountDTORequestResponse> {
     ...
     * @return OK
     */
    accountsPUT(id: string, body: AccountUpdateDTO | undefined): Observable<RequestResponse> {
        let url_ = this.baseUrl + "/api/admin/accounts/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
     ...
     * @return OK
     */
    accountsDELETE(id: string): Observable<RequestResponse> {
        let url_ = this.baseUrl + "/api/admin/accounts/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
     ...
     * @return OK
     */
    update2(body: UserUpdateDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    repliesGET3(requestId: string, id: string): Observable<ReplyDTORequestResponse> {
    ...
    protected processRepliesGET3(response: HttpResponseBase): Observable<ReplyDTORequestResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    repliesGET4(requestId: string, search: string | undefined, page: number | undefined, pageSize: number | undefined): Observable<ReplyDTOPagedResponseRequestResponse> {
    ...
    protected processRepliesGET4(response: HttpResponseBase): Observable<ReplyDTOPagedResponseRequestResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    accept(requestId: string, id: string, body: ReplyUpdateDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    reject(requestId: string, id: string, body: ReplyUpdateDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    requestsGET3(search: string | undefined, page: number | undefined, pageSize: number | undefined): Observable<RequestDTOPagedResponseRequestResponse> {
        let url_ = this.baseUrl + "/api/profile/user/requests?";
        if (search === null)
            throw new Error("The parameter 'search' cannot be null.");
        else if (search !== undefined)
    ...
    protected processRequestsGET3(response: HttpResponseBase): Observable<RequestDTOPagedResponseRequestResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    requestsGET4(id: string): Observable<RequestDTORequestResponse> {
    ...
    protected processRequestsGET4(response: HttpResponseBase): Observable<RequestDTORequestResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update3(body: RequestUpdateDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    update4(body: SpecialistUpdateDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    repliesGET5(requestId: string, search: string | undefined, page: number | undefined, pageSize: number | undefined): Observable<ReplyDTOPagedResponseRequestResponse> {
        let url_ = this.baseUrl + "/api/profile/specialist/requests/{requestId}/replies?";
        if (requestId === undefined || requestId === null)
            throw new Error("The parameter 'requestId' must be defined.");
        url_ = url_.replace("{requestId}", encodeURIComponent("" + requestId));
    ...
    protected processRepliesGET5(response: HttpResponseBase): Observable<ReplyDTOPagedResponseRequestResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    repliesGET6(requestId: string, id: string): Observable<ReplyDTORequestResponse> {
    ...
    protected processRepliesGET6(response: HttpResponseBase): Observable<ReplyDTORequestResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    requestsGET5(id: string): Observable<RequestDTORequestResponse> {
    ...
    protected processRequestsGET5(response: HttpResponseBase): Observable<RequestDTORequestResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    requestsGET6(search: string | undefined, page: number | undefined, pageSize: number | undefined): Observable<RequestDTOPagedResponseRequestResponse> {
    ...
    protected processRequestsGET6(response: HttpResponseBase): Observable<RequestDTOPagedResponseRequestResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    accept2(id: string, body: RequestUpdateDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    reject2(id: string, body: RequestUpdateDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    transactionsPOST(body: TransactionAddDTO | undefined): Observable<RequestResponse> {
     ...
     * @return OK
     */
    transactionsGET5(search: string | undefined, page: number | undefined, pageSize: number | undefined): Observable<TransactionDTOPagedResponseRequestResponse> {
        let url_ = this.baseUrl + "/api/profile/user/transactions?";
        if (search === null)
            throw new Error("The parameter 'search' cannot be null.");
        else if (search !== undefined)
     ...
     * @return OK
     */
    transactionsGET6(id: string): Observable<TransactionDTORequestResponse> {
     ...
     * @return OK
     */
    cancel(id: string): Observable<RequestResponse> {
...
export class BecomeClient extends BaseClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    specialist(body: SpecialistAddDTO | undefined): Observable<RequestResponse> {
...
export class CategoryAdminDTOPagedResponse implements ICategoryAdminDTOPagedResponse {
    ...
    pageSize?: number;
    totalCount?: number;
    data?: CategoryAdminDTO[] | undefined;
...
export class RequestDTO implements IRequestDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.receiverUser = _data["receiverUser"] ? UserContactInfoDTO.fromJS(_data["receiverUser"]) : <any>undefined;
...
export class TransactionDTO implements ITransactionDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.initiatorUser = _data["initiatorUser"] ? UserTransactionDTO.fromJS(_data["initiatorUser"]) : <any>undefined;
            this.senderUserId = _data["senderUserId"];
